...
namespace Lantern.EQ.Editor
{
    public static class MusicRecorder
    {
        ...
        [MenuItem("EQ/MusicRecorder/Record All")]
        public static void CreateAllAudioTracks()
        {
            var usedTracksPath = Path.Combine(Application.streamingAssetsPath, "ClientData/music_tracks_used.txt");
            ...
            var tracksPath = Path.Combine(Application.streamingAssetsPath, "ClientData/music_tracks.txt");
        ...
        {
            var sfFilePath = Path.Combine(Application.streamingAssetsPath, _soundFontName);
