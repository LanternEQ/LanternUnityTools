...
{
    /// <summary>
    /// Sets mesh vertex color values for static objects
    /// </summary>
    public class VertexColorSetter : MonoBehaviour
    {
        ...
        [SerializeField] private ZoneAmbientLightValues _sunlightValues;
        ...
        private void ApplyColorData()
        {
            if (_colors.Count == 0)
            {
                ...
                {
                    _sunlightValues = FindObjectOfType<ZoneAmbientLightValues>();
                }
